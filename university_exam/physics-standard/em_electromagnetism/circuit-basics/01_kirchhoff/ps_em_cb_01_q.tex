...
\begin{enumerate}
    ...
    \item 図のように，電池E（起電力$V_0$），電気抵抗R$_1$（抵抗値$2R$），R$_2$（抵抗値$R$），
        ...
        \par \vspace{0.2\baselineskip}
         {\centering
            \includegraphics{\subfix{fig_em_cb_01/fig_em_cb_01_02_q.pdf}}
        \par}
        \vspace{0.2\baselineskip}
    ...
    \item 図のように，電池E$_1$（起電力$2V_0$），E$_2$（起電力$V_0$），
        ...
        \par \vspace{0.2\baselineskip}
        {\centering
            \includegraphics{\subfix{fig_em_cb_01/fig_em_cb_01_03_q.pdf}}
        \par}
        \vspace{0.2\baselineskip}
    ...
    \item \needspace{10\baselineskip} 
        ...
        \par \vspace{0.2\baselineskip}
        {\centering
            \includegraphics{\subfix{fig_em_cb_01/fig_em_cb_01_04_q.pdf}}
        \par}
        \vspace{0.2\baselineskip}

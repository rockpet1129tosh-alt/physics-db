...
\begin{enumerate}
    ...
    \item 図のように，電池E（起電力$V_0$），電気抵抗$\mathrm{R}_1$（抵抗値$2R$），
        ...
        {\centering
            \includegraphics{\subfix{fig_em_cx_03/fig_em_cx_03_01.pdf}}
        \par}
    ...
    \item 図のように，電池E（起電力$V_0$），
        ...
        \par \vspace{0.2\baselineskip}
        {\centering
            \includegraphics{\subfix{fig_em_cx_03/fig_em_cx_03_02.pdf}}
        \par}
        \vspace{0.2\baselineskip}
    ...
    AB間の合成抵抗$R_\mathrm{T}$を求めよ．
        \par \vspace{0.2\baselineskip}
        {\centering
        \includegraphics{\subfix{fig_em_cx_03/fig_em_cx_03_03.pdf}}
        \par}
        \vspace{0.2\baselineskip}
    ...
    \item \needspace{8\baselineskip}
        ...
        \par \vspace{0.2\baselineskip}
        {\centering
            \includegraphics{\subfix{fig_em_cx_03/fig_em_cx_03_04.pdf}}
        \par}
        \vspace{0.2\baselineskip}
    ...
    \item \needspace{8\baselineskip}
        ...
        \par \vspace{0.2\baselineskip}
        {\centering
            \includegraphics{\subfix{fig_em_cx_03/fig_em_cx_03_05.pdf}}
        \par}
        \vspace{0.2\baselineskip}

...
\begin{document}
    図\ref{fig:uem_phy_oka_2025_uni_02_q_01}のように，電極a，bおよび平板cを互いに平行に設置した．%
    ...
    \begin{enumerate}
        ...
        \item%
            ...
            図\ref{fig:uem_phy_oka_2025_uni_02_q_01}に示すように，$x$軸は平板cに垂直，%
            $z$軸は紙面奥向きを正とする．
        \item%
    ...
    \begin{minipage}{\linewidth}
        ...
        \centering
            \includegraphics{fig_uem_phy_oka_2025_uni_02/fig_uem_phy_oka_2025_uni_02_q_01.pdf}
            \captionof{figure}{} \label{fig:uem_phy_oka_2025_uni_02_q_01}
    \end{minipage}
\end{document}
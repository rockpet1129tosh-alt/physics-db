...
\begin{document}
    図のように，電池$\mathrm{E}$（起電力$V_0$），コンデンサ$\mathrm{C}_1$（容量$C$），%
    $\mathrm{C}_2$（容量$2C$），スイッチ$\mathrm{S}_1$，$\mathrm{S}_2$からなる回路がある．%
    ...
    $\displaystyle y_\infty=\lim_{n \to \infty} y_n$を次の2通りの考え方で求めよ．
    ...
    \begin{minipage}{\linewidth}
        \centering
            \includegraphics{\subfix{fig_uem_phy_std_em_cx_04/fig_uem_phy_std_em_cx_04_00_q.pdf}}
    \end{minipage}
\end{document}
